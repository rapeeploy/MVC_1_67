...
public class BrownTeam {
    Cow brown_no1 = new Cow();
    Cow brown_no2 = new Cow();
    Cow brown_no3 = new Cow();
    ...
    public void setError_report() {
        this.brown_no1.setError_report(10);
        this.brown_no2.setError_report(10);
        this.brown_no3.setError_report(10);
    }
